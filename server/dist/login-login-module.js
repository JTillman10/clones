...
/***/ "./src/app/auth/login/containers/login/login.component.html":
/*!******************************************************************!*\
  !*** ./src/app/auth/login/containers/login/login.component.html ***!
  \******************************************************************/
...
module.exports = "<auth-form (submitted)=\"loginUser($event)\">\n  <span class=\"auth-form-title\">Log in</span>\n  <a routerLink=\"/auth/register\">Not registered?</a>\n  <span class=\"auth-form-button\">Log in</span>\n  <p class=\"error subtitle has-text-danger has-text-centered\" *ngIf=\"error\">\n    {{ error }}\n  </p>\n</auth-form>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'login',
            template: __webpack_require__(/*! ./login.component.html */ "./src/app/auth/login/containers/login/login.component.html"),
            styles: [__webpack_require__(/*! ./login.component.scss */ "./src/app/auth/login/containers/login/login.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], LoginComponent);
...
/* harmony import */ var _containers_login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./containers/login/login.component */ "./src/app/auth/login/containers/login/login.component.ts");
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/shared.module */ "./src/app/auth/shared/shared.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ROUTES = [{ path: '', component: _containers_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] }];
